...
void TrackToolTip(HWND hwnd, int first_time)
{
    ...
    if (dfp_index != LB_ERR && index == dfp_index) {
        ...
        WCHAR *text = AvastSboxDll_FormatMessage0(MSG_3252);
        wcscpy(boxtext, text);
        LocalFree(text);
        ...
        if (_wcsicmp(boxname, L"DefaultBox") == 0) {
            ...
            if (si.dwFlags &
                ...
                WCHAR *text = AvastSboxDll_FormatMessage0(MSG_3254);
                wcscpy(boxtext, text);
                LocalFree(text);
            }
        }
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            SetDlgItemText(hwnd, IDRUNDLGTEXT,
                           AvastSboxDll_FormatMessage0(MSG_3106));
            ...
            if (0 == SbieApi_QueryProcess(
                ...
                if (boxdlg_run_outside_sandbox && CanDisableForce()) {
                    ...
                    WCHAR *text = AvastSboxDll_FormatMessage0(MSG_3251);
                    for (x = 0; x < 40; ++x)
        ...
        case WM_COMMAND:
            ...
            if (LOWORD(wParam) == IDBOXLIST &&
                ...
                if (dfp_index != LB_ERR && index == dfp_index) {
                    ...
                    rc = MessageBox(hwnd,
                                    AvastSboxDll_FormatMessage0(MSG_3253),
