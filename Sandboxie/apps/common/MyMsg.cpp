...
{
    Construct(AvastSboxDll_FormatMessage0(msgid));
}
...
{
    Construct(AvastSboxDll_FormatMessage1(msgid, p1));
}
...
{
    Construct(AvastSboxDll_FormatMessage2(msgid, p1, p2));
}
    ...
    ULONG msgid, const WCHAR *p1, const WCHAR *p2, const WCHAR *p3)
{
    ...
    ins[2] = (WCHAR *)p2;
    ins[3] = (WCHAR *)p3;
    Construct(AvastSboxDll_FormatMessage(msgid, ins));
}
